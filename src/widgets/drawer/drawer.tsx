...
import { DrawerEmpty, DrawerInfo } from "../../entities";

export default function Drawer() {
  const [cartList, setCartList] = useState(null);
  return (
    <div className="z-50 h-screen max-h-[1040px] w-[540px] absolute top-[2px] right-5 bg-[#5C5C5C] rounded-[20px] p-10 flex flex-col">
      <div
              ...
              <div className="w-full h-full flex flex-col justify-between">
                <div className="flex justify-between items-start ">
                  <h2 className="inline cursor-pointer max-w-64 hover:text-primary duration-200">
                    Набор кейкапов: Re:Life In A Different World From Zero
                  </h2>
