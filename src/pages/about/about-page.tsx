    ...
    <div className="mx-[10%]">
      <div className="h-full w-full flex justify-center relative">
        ...
        <div className="mt-16 flex flex-col items-center text-center text-[24px] max-w-[920px]">
          <img className="max-w-[440px] mb-12" src={`${import.meta.env.BASE_URL}keyboard.svg`} alt="" />
          <p>
      ...
      <div className="flex items-center gap-10 mt-32">
        ...
        <img className="w-80 h-72" src={`${import.meta.env.BASE_URL}donut.svg`} alt="" />
      </div>
      <div className="flex gap-10 items-center justify-end mt-[100px]">
        <img src={`${import.meta.env.BASE_URL}dice.svg`} alt="" />
        <div>
      ...
      <div className="flex items-center gap-10 mt-32">
        ...
        <img className="w-80 h-72" src={`${import.meta.env.BASE_URL}earth.svg`} alt="" />
      </div>
      <div className="flex items-center gap-10 mt-32 mb-24">
        <img className="w-80 h-72" src={`${import.meta.env.BASE_URL}gear.svg`} alt="" />
        <div>
